...
void loop() {
// Declare variable, for example "speed" (Remember that "get_speed_mms()" function, return a float variable).
float speed;

// assign the speed (mm/s) to "speed" variable
speed = Motor_Left.get_speed_mms();

// finally, print "speed" variable through Serial Terminal
