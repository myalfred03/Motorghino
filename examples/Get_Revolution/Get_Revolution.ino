...
void loop() {
// Declare variable, for example "rev" (Remember that "get_revolutions" function, return a long variable).
long rev;

// assign the revolutions to "rev" variable
rev = Motor_Left.get_revolutions();
